    ...
    const loadCheckout = async (priceId) => {
        const docRef = await db
            ...
            docRef.onSnapshot(async(snap) => {
                ...
                if (sessionId) {
                    // we have a session, let's reditect to checkout
                    // Init Stripe

                    const stripe = await loadStripe("pk_test_51MMeeDBdLYCvC6QYQGFeZUhPy2syg7U8rb6wQYdvyrGzFDCpJrtiEvo49QHZY2cR48QBOm83GByyFIZ0cvjB9EI900hYJtK21R");
